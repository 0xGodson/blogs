...
* After some time, <a href="https://twitter.com/IvarsVids">IvarVids</a> texted that, `myObj.__proto__.toString` is not the correct way of calling,and  mentioned to use `Object.prototype.toString.call(myObj)` instead of this. kudos to <a href="https://twitter.com/IvarsVids">IvarVids</a>
